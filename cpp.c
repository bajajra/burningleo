...
static bool guarded(char *path) {
    ...
    define_obj_macro("__30bl_include_guard", r ? cpp_token_one : cpp_token_zero);
    return r;
}
...
static void init_predefined_macros() {
    ...
    vec_push(std_include_path, "/usr/local/lib/30bl/include");
    ...
    read_from_string("#include <" BUILD_DIR "/include/30bl.h>");
}
